...
$params = new \app\models\Parametres();
?>
...
<div class="user-form">
    ...
    <?= $form->field($model, 'fk_personne')->dropDownList(\app\models\Personnes::getMoniteurs($model->fk_personne), ['prompt'=>'Choisir une personne']) ?>
    <?= $form->field($model, 'interface_language')->dropDownList($params->optsLangueInterface()) ?>
