...
use leo\modules\UserManagement\components\UserIdentity;
 ...
 * @property integer $interface_language
	...
	*/
	public function rules()
	{
		return [
			...
			[['status', 'email_confirmed', 'fk_personne', 'interface_language'], 'integer'],
	...
	public function attributeLabels()
	{
		return [
			...
			'fk_personne'        => Yii::t('app', 'Personne liée'),
		];
	}
    ...
    {
        return $this->hasOne(\app\models\Personnes::className(), ['personne_id' => 'fk_personne']);
    }
}
